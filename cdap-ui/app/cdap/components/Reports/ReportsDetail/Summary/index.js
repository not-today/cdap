...
import {humanReadableDate, formatDuration} from 'services/helpers';
...
function renderDuration(summary) {
  ...
  let min = formatDuration(durations.min);
  let max = formatDuration(durations.max);
  let average = formatDuration(Math.round(durations.average));
