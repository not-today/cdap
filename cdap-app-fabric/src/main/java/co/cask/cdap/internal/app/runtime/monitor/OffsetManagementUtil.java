...
public class OffsetManagementUtil {
  ...
  /**
   * Initialize offsets for given runtime.
   */
  ...
  /**
   * Persists offsets for given runtime for each topic {@link RuntimeMonitor} is monitoring
   */
  ...
  /**
   * Cleans up offsets persisted for given runtime for each topic {@link RuntimeMonitor} is monitoring
   */
  ...
  /**
   * Creates App metadata store instance.
   */
